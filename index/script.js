...
async function getSongs(folder) {
    ...
    for (const song of songs) {
        songUL.innerHTML = songUL.innerHTML + `<li><img class="invert" width="34" src="/img/msymbol.png" alt="">
                            <div class="info">
...
const homePageUrl = '/index/index.html'; // or any other URL you want to consider as the home page
...
if (window.location.href === homePageUrl) {
    homeIcon.disabled = true; // disable the icon
}


// const nextIcon = document.getElementById('next-icon');
// const nextPageUrl = '/index/index.html'; // or any other URL you want to consider as the home page
...
// // Check if we're on the home page
// if (window.location.href === nextPageUrl) {
//     nextIcon.disabled = true; // disable the icon
// }